// import pizzaLogo from './img/pizzaLogo'
        ...
        <div className="header">
          <div className="container">
            <div className="header__logo">
              <img width="38" src='../img/pizza-logo' alt="Pizza logo" />
              <div>
                <h1>React Pizza</h1>
          ...
          <div className="container">
            ...
            <div className="content__items">
              <div className="pizza-block">
                <img className="pizza-block__image" src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=500" alt="Pizza" />
              ...
              <div className="pizza-block">
                <img className="pizza-block__image" src="https://images.unsplash.com/photo-1541745537411-b8046dc6d66c?w=500" alt="Pizza" />
                <h4 className="pizza-block__title">Чизбургер-пицца</h4>
                <div className="pizza-block__selector">
                  <ul>
                    <li className="active">тонкое</li>
              ...
              <div className="pizza-block">
                <img className="pizza-block__image" src="https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500" alt="Pizza" />
                <h4 className="pizza-block__title">Чизбургер-пицца</h4>
                <div className="pizza-block__selector">
                  <ul>
                    <li className="active">тонкое</li>
              ...
              <div className="pizza-block">
                <img className="pizza-block__image" src="https://images.unsplash.com/photo-1593560708920-61dd98c46a4e?w=500" alt="Pizza" />
                <h4 className="pizza-block__title">Чизбургер-пицца</h4>
                <div className="pizza-block__selector">
                  <ul>
                    <li className="active">тонкое</li>
              ...
              <div className="pizza-block">
                <img className="pizza-block__image" src="https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=500" alt="Pizza" />
                <h4 className="pizza-block__title">Чизбургер-пицца</h4>
                <div className="pizza-block__selector">
                  <ul>
                    <li className="active">тонкое</li>
              ...
              <div className="pizza-block">
                <img className="pizza-block__image" src="https://images.unsplash.com/photo-1511689660979-10d2b1aada49?w=500" alt="Pizza" />
                <h4 className="pizza-block__title">Чизбургер-пицца</h4>
                <div className="pizza-block__selector">
                  <ul>
                    <li className="active">тонкое</li>
              ...
              <div className="pizza-block">
                <img className="pizza-block__image" src="https://images.unsplash.com/photo-1604382355076-af4b0eb60143?w=500" alt="Pizza" />
                <h4 className="pizza-block__title">Чизбургер-пицца</h4>
                <div className="pizza-block__selector">
                  <ul>
                    <li className="active">тонкое</li>
              ...
              <div className="pizza-block">
                <img className="pizza-block__image" src="https://images.unsplash.com/photo-1514326640560-7d063ef2aed5?w=500" alt="Pizza" />
                <h4 className="pizza-block__title">Чизбургер-пицца</h4>
                <div className="pizza-block__selector">
                  <ul>
                    <li className="active">тонкое</li>
              ...
              <div className="pizza-block">
                <img className="pizza-block__image" src="https://images.unsplash.com/photo-1594007654729-407eedc4be65?w=500" alt="Pizza" />
                <h4 className="pizza-block__title">Чизбургер-пицца</h4>
                <div className="pizza-block__selector">
                  <ul>
                    <li className="active">тонкое</li>
